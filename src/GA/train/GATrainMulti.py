...
if __name__ == '__main__':
    ...
    GA_small_trainer = GATrainer(image_shape, input_feature_size, output_feature_size, NUM_AGENTS, device, False)
    GA_large_trainer = GATrainer(image_shape, input_feature_size, output_feature_size, NUM_AGENTS, device, False)
    try:
        GA_small_trainer.load_model("GA_model_small_final.pt")
